...
WxPay.set_apiclient_by_pkcs12(File.read('/mnt/d/cert/coffee/apiclient_cert.p12'), '1602265071')
#WxPay.set_apiclient_by_pkcs12(File.read('/home/cert/coffee/apiclient_cert.p12'), '1602265071')
